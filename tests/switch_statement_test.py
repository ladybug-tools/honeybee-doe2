...
def test_switch_true():
    ...
    honeybee_model_to_inp(hb_model, hvac_mapping='model', exclude_interior_walls=False, exclude_interior_ceilings=False,switch_statements=True,
...
def test_switch_false():
    ...
    if out_file.exists():
        out_file.unlink()
    hb_model = Model.from_file(hb_json)
    honeybee_model_to_inp(hb_model, hvac_mapping='model', exclude_interior_walls=False, exclude_interior_ceilings=False,switch_statements=False,
